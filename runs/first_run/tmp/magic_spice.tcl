...
if { [info exist ::env(MAGIC_EXT_USE_GDS)] && $::env(MAGIC_EXT_USE_GDS) } {
	...
	def read /openLANE_flow/designs/digital_pll/runs/first_run/results/routing/digital_pll.def
}
load digital_pll -dereference
cd /openLANE_flow/designs/digital_pll/runs/first_run/results/magic/
extract do local
